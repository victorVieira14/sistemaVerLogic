<?php 
	...
	$sql = "INSERT INTO moto(modfab, dataInsp, luzD, luzT, luzF,piscaA, piscaD, piscaT, alarmeR, extintor, retrovisor, portas, cinto, oleo, gasolina, resp, tecnico, operador, obs) 
    VALUES
