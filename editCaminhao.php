<?php
    ...
    $sql = "UPDATE caminhao SET modfab = :MODELO, dataInsp = :INSP, luzD = :DIANT, luzT = :TRAZ, luzF = :FREIO, piscaA = :ALERT, piscaD = :PISCA, piscaT = :PISCAT, alarmeR = :RE, extintor = :EXT, retrovisor = :ESP, portas = :PORTA, cinto = :CINTO, oleo = :OLEO, gasolina = :GAS, resp = :RESP, tecnico = :TEC, operador = :OP, obs = :OBS WHERE id = :ID";
