...
<body>
    ...
    <div id="escrever" class="h1 text-center mt-5">CHECKLIST MOTO   <img src="img/moto.png" alt="carro" width="300" height="300"></div>

            <form method="post" class="form-group" action="editMoto.php">
