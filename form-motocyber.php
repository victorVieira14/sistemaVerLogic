...
<body>
    ...
    <div class="container">
        ...
        <div id="escrever" class="h1 text-center mt-5">CHECKLIST MOTOCYBER   <img src="img/moto.png" alt="carro" width="300" height="300"></div>


            <form method="post" class="form-group" action="addCheckMoto.php">
                ...
                <table class="table">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 md-12 lg-12">
                            ...
                            <input type="text" require="" id="mod" style="border-bottom: 2px solid #27408B;" name="modelo" class="form-control">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 md-6 lg-6">
                            ...
                            <input type="date" require="" id="data" style="border-bottom: 2px solid #27408B;" name="inspecao" class="form-control">
                        </div>
                        ...
                        <div class="col-sm-6 md-6 lg-6">
                            ...
                            <div class="input-group mb-3">
                                <select name="dianteira" require="" class="custom-select mt-2" id="inputGroupSelect01">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 md-6 lg-6">
                            ...
                            <div class="input-group mb-3">
                                <select name="traseira" require="" class="custom-select" style="background-color:transparent;" id="inputGroupSelect02">
                                    <option selected disabled="">Informe</option>
                                    <option value="OK">OK</option>
                                    <option value="NAO_ESTA_EM_BOM_ESTADO">Não está em bom estado</option>
                                    <option value="NAO_INFORMADO">Não informado</option>
                        ...
                        <div class="col-sm-6 md-6 lg-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="freio" require="" class="custom-select" id="inputGroupSelect03">
                                    <option selected disabled="">Informe</option>
                                    <option value="OK">OK</option>
                                    <option value="NAO_ESTA_EM_BOM_ESTADO">Não está em bom estado</option>
                                    <option value="NAO_INFORMADO">Não informado</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 md-6 lg-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="alerta" require="" class="custom-select" id="inputGroupSelect04">
                                    <option selected disabled="">Informe</option>
                                    <option value="OK">OK</option>
                                    <option value="NAO_ESTA_EM_BOM_ESTADO">Não está em bom estado</option>
                                    <option value="NAO_INFORMADO">Não informado</option>
                        ...
                        <div class="col-sm-6 md-6 lg-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="pisca" require="" class="custom-select" id="inputGroupSelect05">
                                    <option selected disabled="">Informe</option>
                                    <option value="OK">OK</option>
                                    <option value="NAO_ESTA_EM_BOM_ESTADO">Não está em bom estado</option>
                                    <option value="NAO_INFORMADO">Não informado</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 md-6 lg-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select name="piscaT" require="" class="custom-select" id="inputGroupSelect06">
                                    <option selected disabled="">Informe</option>
                                    <option value="OK">OK</option>
                                    <option value="NAO_ESTA_EM_BOM_ESTADO">Não está em bom estado</option>
                                    <option value="NAO_INFORMADO">Não informado</option>
