...
<main role="main" class="container-fluid">
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        ...
        <p class="lead text-black">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
      </div>
    ...
    <div class="row featurette center">
      <div class="col-md-7">
        ...
        <p class="lead text-black">Com o seu cadastro feito, você poderá ter acesso aos dados que nossa empresa oferece a você</p>
