            ...
            <table class="table text-white" style="background-color: #27408B;">
                ...
                <tbody style="background-color:rgba(0,0,0,.6);">
                    <?php 
                        ...
                        $conn = db_connect();
                        $consulta = $conn->query("SELECT * FROM caminhao");
                        ...
                        while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
                            echo "
                                <tr>
                                    ...
                                    <td>
                                    <a href='form-edit-truck.php?id={$linha['id']}'><button type='button' class='btn text-white btn-sm text-center' style='background-color: #27408B;'>EDITAR</button></a>
                                    <a href='deleteCaminhao.php?id={$linha['id']}'><button type='button' class='btn btn-sm btn-danger text-center'>EXCLUIR</button></a>
                            </td>
                                </tr>
                            ";
                        }
